...
object CaseStudy5Task2 {
  def main(args: Array[String]) {
    ...
    val rawData = sc.textFile("/home/acadgild/casestudy5/")
    ...
    val sourcePath = new Path("/home/acadgild/casestudy5/");
    ...
    val hdfsfile = sc.textFile("hdfs://localhost:8020/casestudy5/task_1")
    ...
    val LFSWCfile = Source.fromFile("/home/acadgild/casestudy5/task2_1/part-00000").getLines().toArray
    val hdfsWCfile= Source.fromFile("/home/acadgild/casestudy5/task2_2/part-00000").getLines().toArray
